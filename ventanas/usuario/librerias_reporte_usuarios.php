...
function acciones_usuario($identificacion){
	...
	$cadena = "<button class='btn btn-light ver_usuario' idusuario='" . $identificacion . "' id='usuario_" . $identificacion . "' data-toggle='modal' data-target='.bd-example-modal-lg'><i class='fas fa-address-card'></i></button>";
